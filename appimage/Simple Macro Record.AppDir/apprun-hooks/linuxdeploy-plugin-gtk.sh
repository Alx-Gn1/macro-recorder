...
/media/alex/Dev/Dev/LinuxApp/rust_macro_record/src-main/src-tauri/target/release/bundle/appimage/Simple Macro Record.AppDir/usr/lib/x86_64-linux-gnu/gio/modules"
